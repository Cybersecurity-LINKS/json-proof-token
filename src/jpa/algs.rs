...
impl Into<PresentationProofAlgorithm> for ProofAlgorithm  {
    fn into(self) -> PresentationProofAlgorithm {
        match self {
            ...
            ProofAlgorithm::BLS12381_SHAKE256 => PresentationProofAlgorithm::BLS12381_SHAKE256_PROOF,
...
impl FromStr for PresentationProofAlgorithm {
  ...
  fn from_str(s: &str) -> Result<Self, Self::Err> {
      match s {
          ...
          "BBS-BLS12381-SHAKE256-PROOF" => Ok(PresentationProofAlgorithm::BLS12381_SHAKE256_PROOF),
